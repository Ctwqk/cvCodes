...
using namespace std;
using namespace cv;
int CalPos(Mat &frame,Mat &tvec,Mat &rvec,Mat &camera_matrix,vector<double> &distCoef,int x,int y,vector<vector<Point3f>> &targets,vector<vector<Point2f>>results,Scalar scalars){
	/*
